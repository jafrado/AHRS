...
//To print a previously stored calibration in EEPROM
#define ADAFRUIT_SENSOR_PRINT_CALIBRATION_HARDCODED
#else
...
#ifdef ADAFRUIT_SENSOR_CALIBRATION_HARDCODED
#include "Adafruit_Sensor_Calibration_hardcoded.h"
#endif
